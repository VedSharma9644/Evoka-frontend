...
toast.error("Please log in to rate the event");
    ...
    return (
        ...
        <div className="min-h-screen bg-gray-100 py-8 px-4 sm:px-6 lg:px-8">
            {showParticipateModal?(<ParticipateModal closeParticipate={closeParticipate} event={event} language={language}/>): null}
                        ...
                        <div className="rounded-lg overflow-hidden shadow-lg">
                            {uniqueImages.length > 0 ? (
                                ...
                                <div className="w-full h-80 bg-gray-200 flex items-center justify-center">
                                    <span className="text-gray-500">{getTranslation(language,"event.No images available")}</span>
                                </div>
                            )}
                        </div>
